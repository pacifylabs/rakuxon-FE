      ...
      <main id="main">
        <SectionBand labelledBy="dashboard-heading">
          ...
          <p className="mt-4 max-w-prose text-base text-text-muted">
            Tenant vetting, catalogue management and the configurable plans and splits land here as
            the later stages ship.
          </p>
          ...
          <section aria-labelledby="scope-heading" className="mt-12">
            ...
            <p className="mt-2 max-w-prose text-sm text-text-muted">
              Plans, limits and commission splits. Every number here is configurable, never
              hard-coded.
            </p>
          </section>
        </SectionBand>
        ...
        <main className="grid min-h-screen place-items-center px-5">
          <div className="max-w-prose text-center">
            ...
            <p className="mt-4 text-base text-text-muted">
              You are signed in, but this area is limited to platform admins. Sign out to use a
              different account.
            </p>
          </div>
        </main>
