...
function Callback() {
  ...
  if (error) {
    return (
      <AuthCard
        ...
        footer={
          <a href="/auth/login" className="rounded-sm font-semibold text-primary underline">
            Back to sign in
          </a>
        }
      >
  ...
  return (
    <AuthCard title="Signing you in" subtitle="One moment." footer={null} ownsMainLandmark={false}>
